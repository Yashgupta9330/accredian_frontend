...
const Table: React.FC = () => {
    return (
        <div className="flex flex-col ml-5 w-full md:max-w-[70%] md:ml-0 rounded-lg" style={{ backgroundColor: "rgba(235, 243, 255, 0.35)",boxShadow: "0px 4px 29.3px 0px rgba(60, 60, 60, 0.38)"}}>
