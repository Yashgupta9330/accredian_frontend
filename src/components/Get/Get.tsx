...
const Get:React.FC = () => {
  return (
    ...
    <div className="self-stretch rounded-xl bg-homeaccrediancom-royal-blue box-border flex flex-col md:flex-row items-end justify-between py-[63px] pr-[50px] pl-12 relative w-[95%] lg:w-4/5 gap-[20px] text-9xl text-homeaccrediancom-nero border-[1px] border-solid border-homeaccrediancom-royal-blue mq1300:flex-wrap mq1300:pl-6 mq1300:pr-[25px] mq1300:box-border">
    <img
      className="h-full w-full hidden md:block absolute !m-[0] top-[0px] right-[0px] bottom-[0px] left-[0px] max-w-full overflow-hidden max-h-full"
      alt=""
      src={circle}
    />
    <div className="w-[661.4px] flex flex-col sm:flex-row items-start justify-start gap-[32px] max-w-full mq900:flex-wrap mq900:gap-[16px]">
      <img
        className="h-20 w-20 relative rounded-xl z-[1]"
        alt=""
        src={headphone}
      />
      <div className="flex-1 flex flex-col items-start justify-start gap-[8px] w-full sm:min-w-[357px] max-w-full mq900:min-w-full">
